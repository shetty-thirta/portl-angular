...
export class PortlUserProfileComponent {
  ...
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer){
    ...
    iconRegistry.addSvgIconLiteral(
      "workout",
      sanitizer.bypassSecurityTrustHtml(Workout_Icon)
    );
    iconRegistry.addSvgIconLiteral(
      "badge",
      sanitizer.bypassSecurityTrustHtml(Badges_Icon)
    );
    iconRegistry.addSvgIconLiteral(
      "time",
    ...
    iconRegistry.addSvgIconLiteral(
      "steps",
      sanitizer.bypassSecurityTrustHtml(Steps_Icon)
    );
    iconRegistry.addSvgIconLiteral(
      "sleep",
      sanitizer.bypassSecurityTrustHtml(Sleep_Icon)
    );
    iconRegistry.addSvgIconLiteral(
      "back",
